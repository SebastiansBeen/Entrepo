...
class FreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create free" do
    assert_difference('Free.count') do
      post frees_url, params: { free: { attachment: @free.attachment, content: @free.content, user_id: @free.user_id } }
    end
  ...
  test "should update free" do
    patch free_url(@free), params: { free: { attachment: @free.attachment, content: @free.content, user_id: @free.user_id } }
